...
namespace ProjectMIDAS.Data.SpectrumLight
{
    ...
    /// </summary>
    public class SpectrumLight : IDisposable
    {
        /// <summary>
        /// Constructor for Spectrum class.
        /// </summary>
        public SpectrumLight()
        {
        ...
        /// </summary>
        public List<sCentroid> Centroids { get; set; } = new List<sCentroid>();
